...
if __name__ == "__main__":
    ...
    well1 = Well("1","well-1",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023','workoverTime' : 2,'priority' : 2,'well_location':(307 , 917),'lossFactor':0.24})
    well2 = Well("2","well-2",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023','workoverTime' : 3,'priority' : 1 ,'well_location':(741 , 293),'lossFactor':0.51})
    well3 = Well("3","well-3",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023', 'workoverTime' : 2,'priority' : 4,'well_location':(299 , 880),'lossFactor':0.93})
    well4 = Well("4","well-4",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023', 'workoverTime' : 2,'priority' : 3,'well_location':(313 , 573),'lossFactor':0.77})
    well5 = Well("5","well-5",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023', 'workoverTime' : 4,'priority' : 5,'well_location':(370 , 606),'lossFactor':0.48})
    well6 = Well("6","well-6",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023','workoverTime' : 2,'priority' : 8,'well_location':(946 , 48),'lossFactor':0.24})
    well7 = Well("7","well-7",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023','workoverTime' : 3,'priority' : 6 ,'well_location':(376 , 278),'lossFactor':0.51})
    well8 = Well("8","well-8",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023', 'workoverTime' : 2,'priority' : 9,'well_location':(353 , 276),'lossFactor':0.93})
    well9 = Well("9","well-9",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023', 'workoverTime' : 2,'priority' : 7,'well_location':(318 , 854),'lossFactor':0.77})
    well10 = Well("10","well-10",{'startTime' : '3-02-2023', 'endTime' : '20-02-2023','workoverTime' : 4,'priority' : 10,'well_location':(939 , 529),'lossFactor':0.48})
    scheduler = Scheduler(
        [rig1,rig2,rig3],
