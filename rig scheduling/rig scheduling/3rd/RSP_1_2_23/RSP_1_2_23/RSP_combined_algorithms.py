        ...
        while len(wells) > 0:
            for i in range(len(rigs)):
                ...
                for k in range(len(wells_dictionary)):
                    #print('kk..................', wells[nearest_well], tuple(wells_dictionary[k]['well_location']))
                    if wells[nearest_well] == tuple(wells_dictionary[k]['well_location']):
...
if __name__ == "__main__":
    ...
    rig1 = Rig("1","Rig1","Drilling", 9200,2600,10,15000, { 'startTime':'04-04-2023 00:00:00.00', 'endTime':'30-04-2023 00:00:00.00', 'rig_location':[100 , 110],'rig_maintance':4,'rig_init_status':'mastUp'})
    rig2 = Rig("2","Rig2","Drilling", 19260,4500,12,20000,{ 'startTime':'04-04-2023 00:00:00.00', 'endTime':'30-04-2023 00:00:00.00', 'rig_location':[110 , 115],'rig_maintance':4,'rig_init_status':'mastDown'})
    rig3 = Rig("3","Rig3","Workover", 1400,1150,5,8000,{ 'startTime':'04-04-2023 00:00:00.00', 'endTime':'30-04-2023 00:00:00.00', 'rig_location':[150 , 190],'rig_maintance':4,'rig_init_status':'mastUp'})
    rig4 = Rig("4","Rig4","Workover", 1300,1100,6,9000,{ 'startTime':'04-04-2023 00:00:00.00', 'endTime':'30-04-2023 00:00:00.00', 'rig_location':[100 , 200],'rig_maintance':4,'rig_init_status':'mastDown'})
...
##    well1 = Well("0","well1","Drilling", 2000,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023','workoverTime' : 2,'priority' : 2,'well_location':'(307 , 917)','lossFactor':0.24})
    ...
    well2 = Well('1', 'well2', 'Drilling', 9000, {'startTime': '2-02-2023', 'endTime': '8-03-2023', 'workoverTime': 3, 'priority': 1, 'well_location': [110 , 125], 'lossFactor': 0.14})
    well3 = Well('2', 'well3', 'Drilling', 5000, {'startTime': '27-02-2023', 'endTime': '21-03-2023', 'workoverTime': 2, 'priority': 5, 'well_location': [120 , 135], 'lossFactor': 0.38})
    well4= Well('3', 'well4', 'Drilling', 7642, {'startTime': '14-02-2023', 'endTime': '23-03-2023', 'workoverTime': 3, 'priority': 5, 'well_location': [115 , 120], 'lossFactor': 0.48})
    well5 = Well('4', 'well5', 'Drilling', 10219, {'startTime': '28-02-2023', 'endTime': '1-03-2023', 'workoverTime': 3, 'priority': 3, 'well_location': [125, 130], 'lossFactor': 0.11})
    well6 = Well('5', 'well6', 'Workover', 1200, {'startTime': '19-02-2023', 'endTime': '21-03-2023', 'workoverTime': 2, 'priority': 1, 'well_location': [130 , 145], 'lossFactor': 0.41})
    well7 = Well('6', 'well7', 'Drilling', 14637, {'startTime': '9-02-2023', 'endTime': '4-03-2023', 'workoverTime': 5, 'priority': 5, 'well_location': [123 , 135], 'lossFactor': 0.27})
    ...
    well9 = Well('8', 'well9', 'Drilling', 8000, {'startTime': '27-02-2023', 'endTime': '7-03-2023', 'workoverTime': 2, 'priority': 1, 'well_location': [140 , 155], 'lossFactor': 0.17})
    well10 = Well('9', 'well10', 'Workover', 800, {'startTime': '2-02-2023', 'endTime': '28-03-2023', 'workoverTime': 4, 'priority': 5, 'well_location': [150 , 115], 'lossFactor': 0.1})
##    well10 = Well("9","well10","Workover",1450,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023','workoverTime' : 4,'priority' : 10,'well_location':[52.33704737951449,24.50588349616796],'lossFactor':0.48})
    well11 = Well("10","well11","Drilling", 2250,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023','workoverTime' : 3,'priority' : 6 ,'well_location':[52,64],'lossFactor':0.51})
    well12 = Well("11","well12","Workover", 1100,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023', 'workoverTime' : 2,'priority' : 9,'well_location':[55,84.],'lossFactor':0.93})
    well13 = Well("12","well13","Workover", 1175,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023', 'workoverTime' : 2,'priority' : 7,'well_location':[59,34],'lossFactor':0.77})
    well14 = Well("13","well14","Workover",1450,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023','workoverTime' : 4,'priority' : 10,'well_location':[62,24],'lossFactor':0.48})
    scheduler = Scheduler(
