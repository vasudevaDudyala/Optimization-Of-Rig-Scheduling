...
if __name__ == "__main__":
    ...
    rig1 = Rig("0","Rig1","Drilling", 9200,2600,10,15000,{'rig_location':[14.475487, 78.814525],'rig_maintance':4,'rig_init_status':'mastUp'})
    rig2 = Rig("1","Rig2","Drilling", 19260,4500,12,20000,{'rig_location':[14.054104, 78.754664],'rig_maintance':4,'rig_init_status':'mastDown'})
    rig3 = Rig("2","Rig3","Workover", 1400,1150,5,8000,{'rig_location':[14.420165, 78.227831],'rig_maintance':4,'rig_init_status':'mastUp'})
...
##            ('0', 'well1', 'Drilling', 1453, {'startTime': '18-02-2023', 'endTime': '22-03-2023', 'workoverTime': '3', 'priority': '5', 'well_location': '(399 , 982)', 'lossFactor': '0.44'})
    well1 = Well('0', 'well1', 'Drilling', 3075, {'startTime' : '7-02-2023',' endTime' : '16-03-2023', 'workoverTime' : 2, 'priority' : 5, 'well_location' : [14.486028, 78.801565], 'lossFactor' : 0.31})
    well2 = Well("1","well2","Drilling", 2200,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023','workoverTime' : 2,'priority' : 1 ,'well_location':[14.472476, 78.842778],'lossFactor':0.51})
    well3 = Well("2","well3","Workover", 1000,{'startTime' : '25-02-2023', 'endTime' : '10-03-2023', 'workoverTime' : 2,'priority' : 4,'well_location':[14.445369,78.832151],'lossFactor':0.93})
    well4 = Well("3","well4","Workover", 1150,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023', 'workoverTime' : 2,'priority' : 3,'well_location':[14.041669, 78.751062],'lossFactor':0.77})
    well5 = Well("4","well5","Workover", 1400,{'startTime' : '24-02-2023', 'endTime' : '10-03-2023', 'workoverTime' : 2,'priority' : 5,'well_location':[14.049479, 78.737715],'lossFactor':0.48})
    well6 = Well("5","well6","Drilling", 2050,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023','workoverTime' : 2,'priority' : 8,'well_location':[14.063557, 78.748626],'lossFactor':0.24})
    well7 = Well("6","well7","Drilling", 2250,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023','workoverTime' : 2,'priority' : 6 ,'well_location':[14.426649, 78.220278],'lossFactor':0.51})
    well8 = Well("7","well8","Workover", 1100,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023', 'workoverTime' : 2,'priority' : 9,'well_location':[14.428727, 78.236328],'lossFactor':0.93})
    well9 = Well("8","well9","Workover", 1175,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023', 'workoverTime' : 2,'priority' : 7,'well_location':[14.419334, 78.215814],'lossFactor':0.77})
    ...
    scheduler = Scheduler(
        [rig1,rig2,rig3],
        [well1,well2,well3,well4,well5,well6,well7,well8,well9],schedulerStartTime,
    )
