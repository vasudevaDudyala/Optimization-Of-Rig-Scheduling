...
class Well(object):
    def __init__(self,id,name,well_type,depth_capacity,wellParams):
        ...
        self.startTime = wellParams['startTime'] #input("enter well {} StartTime in this format dd-mm-yyyy:".format(self.id))
        self.endTime = wellParams["endTime"]
       # self.endTime= '30-03-2023' #input("enter well {} endTime in this format dd-mm-yyyy:".format(self.id))
