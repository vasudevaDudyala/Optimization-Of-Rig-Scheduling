        ...
        while len(wells) > 0:
            for i in range(len(rigs)):
                ...
                for k in range(len(wells_dictionary)):
                    print('pause!')
                    well_loc=ast.literal_eval(wells_dictionary[k]['well_location'])
                    print(wells[nearest_well])
                    if wells[nearest_well] == well_loc:
                        print('ksrm')
...
if __name__ == "__main__":
    ...
    rig1 = Rig("1","Rig1","Drilling", 9200,2600,10,15000,{'rig_location':'(100, 110)','rig_maintance':4,'rig_init_status':'mastUp'})
...
##    well1 = Well("0","well1","Drilling", 2000,{'startTime' : '23-02-2023', 'endTime' : '10-03-2023','workoverTime' : 2,'priority' : 2,'well_location':'(307 , 917)','lossFactor':0.24})
    ...
    well6 = Well('5', 'well6', 'Workover', 1200, {'startTime': '19-02-2023', 'endTime': '21-03-2023', 'workoverTime': 2, 'priority': 1, 'well_location': '(110, 125)', 'lossFactor': 0.41})
    well7 = Well('6', 'well7', 'Drilling', 14637, {'startTime': '9-02-2023', 'endTime': '4-03-2023', 'workoverTime': 5, 'priority': 5, 'well_location': '(110, 125)', 'lossFactor': 0.27})
